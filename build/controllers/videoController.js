      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            searchingBy = req.query.term; // 윗줄코드와 같음
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 4:
            ...
            // populate(): 객체를 데려온다. 객체로 선언된 경우에만 사용할 수 있다.
            console.log(video);
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            _context10.next = 3;
            return _Comment["default"].findById(comment);

          case 3:
            commentData = _context10.sent;
            _context10.prev = 4;
