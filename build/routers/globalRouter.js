...
globalRouter.get(_routes["default"].join, _middlewares.onlyPublic, _userController.getJoin); // routes.js, userController

globalRouter.post(_routes["default"].join, _middlewares.onlyPublic, _userController.postJoin, _userController.postLogin); // postJoin에서 받은 username, password를 postLogin으로 보내줄 것
