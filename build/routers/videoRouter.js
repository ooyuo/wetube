...
videoRouter.post(_routes["default"].upload, _middlewares.onlyPrivate, _middlewares.uploadVideo, _videoController.postUpload); // uploadVideo middleware(video file> url로변환)
// Video Detail
